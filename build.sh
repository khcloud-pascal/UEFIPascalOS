	...
	mkdir installer
	x86_64-w64-mingw32-ld --gc-sections -shared -Bsymbolic --no-keep-memory -nostdlib -oformat=pei-x86-64 uefiinstaller.o uefi.o system.o -e efi_main -o installer.dll
