	fpc -XPx86_64-w64-mingw32- -Aas -n -O- -Si -Sc -Sg -Xd -CX -XXs -Px86_64 -Rintel -Twin64 -Cg uefiinstaller.pas
	fpc -XPx86_64-w64-mingw32- -Aas -n -O- -Si -Sc -Sg -Xd -CX -XXs -Px86_64 -Rintel -Twin64 -Cg uefimain.pas
	mkdir installer
	...
	mkdir kernel
	x86_64-w64-mingw32-ld --gc-sections -shared -Bsymbolic --no-keep-memory -nostdlib -oformat=pei-x86-64 uefimain.o uefi.o system.o -e efi_main -o main.dll
